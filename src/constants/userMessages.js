...
export const MESSAGE_USER_UPDATED = "User updated successfully";
export const MESSAGE_USER_DELETED = "User deleted successfully";
...
export const MESSAGE_PROFILE_IMAGE_UPLOADED =
